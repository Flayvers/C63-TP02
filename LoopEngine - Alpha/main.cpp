...
<<<<<<< HEAD
//Exemple développement dirigées par les tests (version jeu vidéo)
// En anglais Test Driven développement. La vrai version utilise des tests unitaires mais c'est
// long et compliqué en jeu vidéo alors on adapte.
=======


//Exemple dÃ©veloppement dirigÃ©es par les tests (version jeu vidÃ©o)
// En anglais Test Driven dÃ©veloppement. La vrai version utilise des tests unitaires mais c'est
// long et compliquÃ© en jeu vidÃ©o alors on adapte.
>>>>>>> 77e4815017d1f79ecb3a39888bbc035bdc4e77f5
// 
//======Comment faire=====
//1) Choisissez une classe à développer
//2) Créer une fonction vide et seulement cette fonction du main
//3) Choisir une fonctionnalité de la classe (Ex: création/destruction) et écrire un test simple.
//4) Développer et tester en itération jusqu'à ce que ça fonctionne.
//5) Déveloper et tester ensuite les case limites de la même fonctionnalité.
//6) Reprendre à l'étape 3) pour toutes les fonctionnalités.
